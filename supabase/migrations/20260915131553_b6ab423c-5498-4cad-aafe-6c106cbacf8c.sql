...
alter table public.appointments drop constraint if exists appointments_change_set_id_fkey;
alter table public.appointments
...
drop trigger if exists update_facilities_updated_at on public.healthcare_facilities;
